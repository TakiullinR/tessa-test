...
<SchemeTable Partition="dd8eeaba-9042-4fb5-9e8e-f7544463464f" ID="5aac25fd-de4f-450d-9fd5-a1a9168a795c" Name="WeDialogAction" Group="WorkflowEngine" IsVirtual="true" InstanceType="Cards" ContentType="Entries">
	...
	<SchemePhysicalColumn ID="961be981-e5bd-4a4a-9b58-b465ff502e25" Name="NotDisplayTabs" Type="Boolean Not Null">
		<Description>Признак, определяющий, нужно ли скрывать заголовки вкладок или нет.</Description>
		<SchemeDefaultConstraint IsPermanent="true" ID="5cff6a91-40ef-4ab5-ae7e-6c899d41c20f" Name="df_WeDialogAction_NotDisplayTabs" Value="false" />
	</SchemePhysicalColumn>
